...
| v1.4 | 17 Jul 2026 | **UI redesigned** to the provided light "soft SaaS" reference (`docs/design-reference.jpeg`): slate sidebar with zone dots, cream canvas, white rounded cards, sage/indigo/coral/sand palette, Poppins + Inter, rounded app frame; doc 04 → **v2.0**; PlayerShell keeps charcoal chrome inside the light UI |
